...
# flags
CXXFLAGS += -mtune=cortex-a53 -Ofast -ffast-math -Wall -fPIC -DPIC $(shell pkg-config --cflags fftw3f) -I. -I../Shared_files
LDFLAGS += -shared -Wl,-Ofast -Wl,--as-needed -Wl,--no-undefined -Wl,--strip-all $(shell pkg-config --libs fftw3f) -larmadillo -lm
